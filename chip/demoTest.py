...
from chip.util import util
import torch
import numpy as np
from chip.util.getMap import *


def demoTest(model_name, input_path, input_name, attention_thresh):
    # 指定图片读取路径
    opt = TestOptions().parse_demo()  # get test optionss
    ...
    # 修改设置
    img_path = input_path
    model_path = 'chip/demo_files/modelss/'+model_name
    opt.no_dropout = True
